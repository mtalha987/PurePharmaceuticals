...
const Hero = () => {
  return (
    <>
      <div className="bg-hero-pattern bg-no-repeat bg-cover bg-center xs:bg-origin-content mt-7 2xl:px-0 xl:px-[90px] lg:px-10 px-5 xl:pt-[115px] lg::pt-20 sm:pt-10 xs:pt-5  xl:pb-44">
