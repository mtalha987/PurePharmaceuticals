...
const TouchUs = () => {
  return (
    <>
      <div className="xl:px-[90px] 2xl:max-w-[1440px] 2xl:mx-auto 2xl:px-0 lg:px-[40px] px-5 flex sm:mt-20 xs:mt-10 bg-white lg:justify-between flex-wrap justify-center  ">
