    ...
    <>
      <div className="flex flex-col 2xl:justify-between lg:flex-row xl:px-[90px] lg:px-10 px-5 bg-[#0E493F] lg:mt-32 mt-16">
          ...
          <div className="mt-11 flex flex-col gap-6 mb-16">
            <div className="border py-6 pl-9 pr-6">
              ...
              <p className="mt-4 text-white text-base font-normal font-['Inter'] leading-normal w-[90%]">
                ...
                nulla pitecto beatae vitae dicta sunt explicabo. Nemo enim ipsam
                voluptatem quia voluptas sit aspernatur quisquam est, qui
        ...
        <div className="lg:w-[50%] lg:relative">
          <Image src={Doctor} alt="Doctor" className="lg:absolute lg:bottom-0" />
        </div>
      </div>
    </>
  );
